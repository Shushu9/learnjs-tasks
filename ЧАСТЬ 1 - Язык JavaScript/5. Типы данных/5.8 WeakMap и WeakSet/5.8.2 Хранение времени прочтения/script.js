...
messages.forEach(item => {
    weakMap.set(item, new Date);
})

console.log("Read message 0: " + weakMap.get(messages[0]))
console.log("Read message 1: " + weakMap.get(messages[1]))
console.log("Read message 2: " + weakMap.get(messages[2]))