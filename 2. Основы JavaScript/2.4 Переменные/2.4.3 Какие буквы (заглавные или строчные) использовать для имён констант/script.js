...
const BIRTHDAY = '18.04.1982'; // Может т.к. значение константы может быть известно до выполнения скрипта

const AGE = someCode(BIRTHDAY); // нет тк значение вычисляется в процессе 
